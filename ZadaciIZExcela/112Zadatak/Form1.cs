...
namespace _112Zadatak
{
    public partial class Form1 : Form
    {
        ...
        private void txtInputedChar_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtInputedWord_TextChanged(object sender, EventArgs e)
        {
            if (txtInputedWord.Text.Length == 0)
            {
                txtInputedWord.Text = "";
            }
            else
            {
                lblRepetitionOfWord.Text = text.NumberOfInputedWord(txtInputedWord.Text);
            }
        }
    }
}